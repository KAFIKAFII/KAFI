...
./tdlua.so -s ./AEK.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("Run", "w")  
...
send(chat,msg.id_," ✷│هذا الملف ليس تابع لسورس ايبو")
return false 
end      
...
if data.Ch_Member.Aekan ~= true then
Var = false
send(msg.chat_id_,msg.id_,'['..data.Ch_Member.Aekan..']')   
else
Var = true
end
return Var
...
if text == '✷ السورس↫' then 
if SecondSudo(msg) then 
local Sudo_Welcome = '✷│اهلا بك مجددا عزيزي المطور \n✷│اليك الازرار الخاصه بتحديث  سورس ايبو فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
{'✷ تحديث السورس↫','✷ تحديث↫'},
{'✷ السيرفر↫'},
...
if SecondSudo(msg) then 
local Sudo_Welcome = '✷│اهلا بك مجددا عزيزي المطور \n✷│اليك الازرار الخاصه ب أحصائيات  سورس ايبو فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
{'✷ الاحصائيات ↫'},
{'✷ المشتركين↫','✷ المجموعات ↫'},
...
if SecondSudo(msg) then 
local Sudo_Welcome = '✷│اهلا بك مجددا عزيزي المطور \n✷│اليك الازرار الخاصه ب المطورين لسورس ايبو فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
if SecondSudo(msg) then 
local Sudo_Welcome = '✷│اهلا بك مجددا عزيزي المطور \n✷│اليك الازرار الخاصه ب التفعيل والتعطيل لسورس ايبو فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
if SecondSudo(msg) then 
local Sudo_Welcome = '✷│اهلا بك مجددا عزيزي المطور \n✷│اليك الازرار الخاصه بالاذاعه لسورس ايبو فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
{'✷ اذاعه بالتثبيت↫'},
{'✷ اذاعه خاص↫','✷ اذاعه عام↫'},
...
if text == '✷ العام↫' then 
if SecondSudo(msg) then 
local Sudo_Welcome = '✷│اهلا بك مجددا عزيزي المطور \n✷│اليك الازرار الخاصه بالعام لسورس ايبو فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
if SecondSudo(msg) then 
local Sudo_Welcome = '✷│اهلا بك مجددا عزيزي المطور \n✷│اليك الازرار الخاصه بردود الخاص لسورس ايبو فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
if SecondSudo(msg) then 
local Sudo_Welcome = '✷│اهلا بك مجددا عزيزي المطور \n✷│اليك الازرار الخاصه بالاشتراك الاجباري لسورس ايبو فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
local Sudo_Welcome = '✷│اهلا بك مجددا عزيزي \n✷│اليك الازرار الخاصه بالاوامر الخدميه الخاصه بسورس ايبو فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
local Sudo_Welcome = '✷│اهلا بك مجددا عزيزي \n✷│اليك الازرار الخاصه بأوامر التسليه الخاصه بسورس ايبو فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
{'✷ غنيلي↫','✷ اغنيه↫'},
{'✷ ميمز↫','✷ ريمكس↫'},
{'✷ صوره↫','✷ متحركه↫'},
...
local Sudo_Welcome = '✷│اهلا بك مجددا عزيزي \n✷│اليك الازرار الخاصه بأوامر النسب الخاصه بسورس ايبو فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
if text == '✷ العاب↫' then 
local Sudo_Welcome = '✷│اهلا بك مجددا عزيزي \n✷│اليك الازرار الخاصه بألعاب سورس ايبو فقط اضغط على اللعبه الذي تريد لعبها'
local key = {
...
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, './AEK.lua', '✷│نسخة ملف سورس ايبو',dl_cb, nil)
end end
...
local Text = '*✷ أهلاً بك في سورس ايبو، *\n*✷ أضغط على الأزرار بالأسفل،*'
keyboard = {} 
keyboard.inline_keyboard = {
...
io.popen("cd Files && wget https://raw.githubusercontent.com/KAFIKAFII/IDAFAT/main/IDAFAT/AddedMe.lua") 
io.popen("cd Files && wget https://raw.githubusercontent.com/KAFIKAFII/IDAFAT/main/IDAFAT/AutoFile.lua")  
io.popen("cd Files && wget https://raw.githubusercontent.com/KAFIKAFII/IDAFAT/main/IDAFAT/ChangeName.lua") 
io.popen("cd Files && wget https://raw.githubusercontent.com/KAFIKAFII/IDAFAT/main/IDAFAT/ChangePhoto.lua") 
io.popen("cd Files && wget https://raw.githubusercontent.com/KAFIKAFII/IDAFAT/main/IDAFAT/ChangeUser.lua") 
io.popen("cd Files && wget https://raw.githubusercontent.com/KAFIKAFII/IDAFAT/main/IDAFAT/MuteNames.lua") 
io.popen("cd Files && wget https://raw.githubusercontent.com/KAFIKAFII/IDAFAT/main/IDAFAT/ProNames.lua") 
io.popen("cd Files && wget https://raw.githubusercontent.com/KAFIKAFII/IDAFAT/main/IDAFAT/ReplyBot.lua") 
io.popen("cd Files && wget https://raw.githubusercontent.com/KAFIKAFII/IDAFAT/main/IDAFAT/TagAdmins.lua") 
io.popen("cd Files && wget https://raw.githubusercontent.com/KAFIKAFII/IDAFAT/main/IDAFAT/TagAll.lua") 
...
DevAek:set(AEK..'Aek:NameBot',(DevAek:get(AEK..'Name:Bot') or 'ايبو'))
end
for i = 1, #Users do
local id = Users[i]
if id:match("^(%d+)") then
...
local GetJson, Res = https.request("https://raw.githubusercontent.com/KAFIKAFII/IDAFAT/main/IDAFAT/"..FileName)
if Res == 200 then
